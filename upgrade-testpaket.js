                      ...
                      getDocs(accessCollection)
                        .then((querySnapshot) => {
                          if (!querySnapshot.empty) {
                            ...
                            const facAvailable = parseInt(
                              userData.facilityAvailable,
                              10
                            );
